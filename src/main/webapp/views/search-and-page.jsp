...
<body ng-app="mymapp"
				...
				<div class="container">
					<div class="header_top-flex">
						<div class="header_top-left">
							<a href="/product/search" class="logo"> <img
	...
	<div class="poly-sheet row">
		...
		<aside class="col-md-2"
			 style="padding: 20px; padding-left: 70px; border-right: 2px solid rgb(19, 197, 78);">
			<!--CartInfo-->
			<div class="poly-cart">
				<div class="panel panel-default" style="background-color: #010722f5; border-style: inset;">
					<div class="panel-body">
						<a href="/product/search" class="logo"> <img
							src="/images/qc.png" alt="Logo"
							style="width: 180px; height: 80px; border-radius: 10px;">
						</a>
			...
			<div class="nn-cart">
				<div class="panel panel-default" style="background-color: #010722f5;">

					<form action="/product/search/search-and-page" method="post">
						<div class="panel-body">
				...
				<div class="list-group">
					...
					<c:forEach var="category" items="${categories}">
						...
						<a class="list-group-item"
							style="background-color: #010722f5; color: aliceblue; border-style: none;"
							href="/product/search/category/${category.id}">${category.name}</a>
			...
			<div class="panel panel-default" style="border-style: none;">
				<div class="panel-heading"
					...
					<span class="glyphicon glyphicon-star-empty"></span> <strong>Sắp xếp</strong>
				</div>
				...
				<div class="list-group">
					<a class="list-group-item"
						...
						class="fas fa-sort-amount-up"></i> Cao đến thấp</a> <a
		...
		<article class="col-xs-9" style="margin: 20px;">
			...
			<div class="row" style="padding-bottom:50px; padding-left:126px">
				<div id="carouselExampleIndicators"
					...
					<div class="carousel-inner" style="width: 1150px;">
						<div class="carousel-item active">
							<img class="d-block w-100 img-fluid" src="/images/aaa.png"
								alt="1" style="width: 60px; height: 130px;">

						</div>
						<div class="carousel-item">
							<img class="d-block w-100 img-fluid" src="/images/bbb.png"
								alt="2" style="width: 60px; height: 130px;">

						</div>
						<div class="carousel-item">
							<img class="d-block w-100 img-fluid" src="/images/ccc.png"
								alt="3" style="width: 60px; height: 130px;">

						</div>
						<div class="carousel-item">
							<img class="d-block w-100 img-fluid" src="/images/aaa.png"
								alt="4" style="width: 60px; height: 130px;">
				...
				<div class="container">
					<div class="row">
						<c:forEach var="product" items="${page.content}">
							...
							<img class="d-block w-100 img-fluid" src="/images/light.png"
								alt="1" style="width: 60px; height: 12px;">
								<div class="card">
										...
										<div class="btn-group d-flex justify-content-between">
											<form action="/product/search/add-to-cart" method="post">
												...
												<a href="/product/search/product/${product.id}"
													class="btn btn-primary btn-sm" style="font-size: 15px";>Mua
													Ngay</a>


												<button type="submit" class="btn btn-warning btn-sm"
													style="font-size: 15px;">Thêm vào giỏ hàng</button>
					...
					<a href="/product/search/search-and-page?p=0"
						style="text-decoration: none; padding: 5px 10px; background-color: black; color: yellow; border-radius: 5px;">First</a>
					<a href="/product/search/search-and-page?p=${page.number-1}"
						style="text-decoration: none; padding: 5px 10px; background-color: black; color: yellow; border-radius: 5px;">Previous</a>
					<a href="/product/search/search-and-page?p=${page.number+1}"
						style="text-decoration: none; padding: 5px 10px; background-color: black; color: yellow; border-radius: 5px;">Next</a>
					<a href="/product/search/search-and-page?p=${page.totalPages-1}"
						style="text-decoration: none; padding: 5px 10px; background-color: black; color: yellow; border-radius: 5px;">Last</a>
				</div>
			</nav>
