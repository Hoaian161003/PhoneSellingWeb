		...
		<article class="col-xs-9" style="margin: 20px;">
			<div class="row">
				...
				<div class="container">
						...
						<c:forEach var="product" items="${cartItems}">
							<tr>
									...
									<form action="/product/search/cart/update/${product.id}"
										...
										<div class="input-group">
											<input type="number" name="qty" value="${product.qty}"
												class="form-control" style="max-width: 100px;"> <span
								...
								<td><img src="/images/${product.image}" alt="Product Image"
									class="card-img-top" style="width: 80px; height: 80px;"></td>
					...
					<a href="/product/search/cart/clear" class="btn btn-warning"
						style="font-size: 15px;">Clear Cart</a> <a href="/product/search"
						class="btn btn-primary" style="font-size: 15px;">Add More</a> <a
						href="#" class="btn btn-success" style="font-size: 15px;">Thanh
						Toán</a>
