					...
					<div class="header_top-flex">
						...
						<div class="header_top-right">
							<div class="header_cate">
								<ul>
									<li><a href="/account/login"  title="Shop"
									...
									<li><a href="/product/search/add-to-cart" 
				...
				<div class="container">
					<div class="row" >
						...
						<c:forEach var="product" items="${products}" >
							<div class="col-lg-3 col-md-4 col-sm-6" style="padding-bottom: 40px;">
							<img class="d-block w-100 img-fluid" src="/images/light.png"
								alt="1" style="width: 60px; height: 12px; border-radius:2px">
								<div class="card">
